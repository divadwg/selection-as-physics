> Historical hypothesis, superseded by [the assay audit](memristor_q_analysis.md).
> Its claims of empirical confirmation and direct identification of read-noise power with diffusivity are withdrawn.

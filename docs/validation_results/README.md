...
N=8; state interval [1,3]; 4 grid intervals; 128 independent ensembles per seed; 3 seeds; final physical time 16.
...
|---|---:|
| occupancy_cdf_error | 0.017014 |
| flow_cdf_error | 0.021730 |
| snapshot_half_error | 0.011423 |

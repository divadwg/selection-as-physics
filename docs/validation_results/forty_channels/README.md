...
N=40; state interval [1,3]; 8 grid intervals; 128 independent ensembles per seed; 3 seeds; final physical time 16.
...
|---|---:|
| occupancy_cdf_error | 0.009496 |
| flow_cdf_error | 0.008539 |
| snapshot_half_error | 0.001585 |

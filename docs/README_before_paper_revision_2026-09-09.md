# Archived README: before the paper revision of 9 September 2026

This is a historical snapshot. Its broader claims are not the scope of the
[current paper](../paper/README.md). See the [current README](../README.md)
for the distinction between validated results and exploratory extensions.

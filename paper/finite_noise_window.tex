...
\maketitle
\begin{abstract}
Can variation, unequal flow sharing and reproduction be connected within a
physical description of selection? We examine a sequence of models in which
unresolved deterministic dynamics supply effective disturbance, a bounded range
of disturbance scaling permits concentration, and flow can fund copying.
...
simulations check the stationary predictions on bounded grids. Separate lattice
and copying experiments illustrate further steps in the proposed connection.
An inherited-state branching extension predicts a copying-cost threshold and,
under activity-dependent carrier damage, a reversal of restoration's effect
as transit grows. These conditional predictions use established mathematics.
The models do not yet derive channel emergence, the full window and reproduction in
one physical system. Empirical applicability remains untested.
\end{abstract}
...
\section{Drift and related models}
...
The repository audit distinguishes the lineage and transport checks discussed
here from older exploratory models and unreproduced historical summaries.
Their copying, storage and loss rules remain assumptions separate from the
exact stationary result.
...
large-range limit. Its algebra is established moment mathematics. The paper makes that interpretation exact for a coupled model and places it
within a proposed route from deterministic disturbance to selective reproduction.
The lattice and copying examples give concrete steps in that route, while also
exposing the missing connections. The inherited-state extension supplies a copying-cost threshold and a candidate
reversal of restoration's effect when carrier damage grows with activity. These
conditional predictions use established branching mathematics. The scientific
question is whether the steps can be joined under one physically justified set
of rules. Established
mathematics does not answer that question by itself, and the separate examples
do not yet amount to a derivation of natural selection from an energy gradient.
...
\bibitem{schrodinger} E. Schr\"odinger, \emph{What is Life?},
Cambridge University Press (1944), Chapters 2 and 5.
\bibitem{ameta} S. Ameta et al., Darwinian properties and their trade-offs in
 autocatalytic RNA reaction networks, \emph{Nature Communications}
\textbf{12}, 842 (2021).
\href{https://doi.org/10.1038/s41467-021-21000-1}{doi:10.1038/s41467-021-21000-1}.
\bibitem{photocatalysis} Selection for photocatalytic function through Darwinian
 evolution of synthetic self-replicators, \emph{Nature Catalysis}
\textbf{8}, 1000--1009 (2025).
\href{https://doi.org/10.1038/s41929-025-01409-3}{doi:10.1038/s41929-025-01409-3}.
...
\bibitem{puffs} G. Lemoult et al., Directed percolation and puff jamming near
 the transition to pipe turbulence, \emph{Nature Physics} (2024).
\href{https://doi.org/10.1038/s41567-024-02513-0}{doi:10.1038/s41567-024-02513-0}.
\bibitem{speedfidelity} A speed--fidelity trade-off determines the mutation rate
 and virulence of an RNA virus, \emph{PLOS Biology} (2018).
\href{https://doi.org/10.1371/journal.pbio.2006459}{doi:10.1371/journal.pbio.2006459}.
\end{thebibliography}
\end{document}
